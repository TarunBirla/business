...
<div class="bg-sky-50/50 py-12 border-b border-sky-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-slate-900">Community Events & Networking</h1>
        <p class="text-slate-600 mt-2">Attend networking meetups, workshops, cultural gatherings and seminars across the UK.</p>
    </div>
</div>
        ...
        @forelse($events as $event)
            <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between hover:shadow-lg transition">
                <div class="p-6">
                    ...
                    <h3 class="font-bold text-xl text-slate-900 leading-snug">{{ $event->title }}</h3>
