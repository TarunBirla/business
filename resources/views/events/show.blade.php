...
@section('content')
<div class="text-white py-16 shadow-md" style="background-color: var(--btn-primary-bg);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="inline-block px-3 py-1 bg-white/20 text-white rounded-full text-xs font-bold uppercase mb-3">
            {{ $event->group->name }}
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div class="lg:col-span-2 space-y-8">
            <div class="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
                <h2 class="text-2xl font-bold text-black mb-4">Event Description</h2>
            ...
            <div class="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
                <h3 class="text-xl font-bold text-black mb-4">Venue & Location</h3>
