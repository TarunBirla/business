...
<div class="space-y-6">
    <div>
        <h1 class="text-3xl font-bold text-slate-900">CMS Content Manager</h1>
        <p class="text-sm text-slate-600 mt-1">Manage public pages: About, Contact, Privacy Policy, Terms & Conditions, FAQ, Cookie Policy.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        @foreach($pages as $page)
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
                <div>
                    <h3 class="font-bold text-slate-900 text-lg">{{ $page->title }}</h3>
