...
@section('content')
<div class="py-12 border-b border-slate-200" style="background-color: var(--bg-page);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-black">Community Directory</h1>
        <p class="text-black mt-2">Find and join community networking groups across the UK.</p>

        <!-- Search & Filters -->
        <form method="GET" action="{{ route('groups.index') }}" class="mt-8 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <label class="block text-xs font-bold text-black mb-1">Search Name or City</label>
            ...
            <div>
                <label class="block text-xs font-bold text-black mb-1">Filter by City</label>
            ...
            <div>
                <label class="block text-xs font-bold text-black mb-1">Community Type</label>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col justify-between group">
                <div>
                    ...
                    <div class="pt-8 px-6 pb-6">
                        <h3 class="text-xl font-bold text-black group-hover:text-sky-600 transition">{{ $group->name }}</h3>
                        ...
                        <p class="text-sm text-black mt-3 line-clamp-3 leading-relaxed">
                            {{ $group->description }}
                        </p>
                    </div>
                </div>
                <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                    <div class="text-xs text-black font-semibold space-x-2">
